# cloud-itonami-iso3166-ken

Open ISO 3166 Blueprint for **KEN**: Kenya.
...
tax registration, and local-content rules in Kenya, so the operator
...
- **Not the government of Kenya.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Kenya-licensed counsel
...
(ISO 3166 `KEN`). Required capabilities:
